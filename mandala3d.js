...
const LAYERS = [
  {
    ...
    `,
    color: new THREE.Color(0x3a3228),
    emissive: new THREE.Color(0x4a3f32),
    particleColor: 0x5e4f3a,
    geometry: 'dodecagram',
    n: 12,
    radius: 42
  },
  {
    ...
    `,
    color: new THREE.Color(0x4a3f32),
    emissive: new THREE.Color(0x5e4f3a),
    particleColor: 0x7d6245,
    geometry: 'hexagonal',
    n: 6,
    radius: 36
  },
  {
    ...
    `,
    color: new THREE.Color(0x5e4f3a),
    emissive: new THREE.Color(0x7d6245),
    particleColor: 0x9a7555,
    geometry: 'octagram',
    n: 8,
    radius: 30
  },
...
function init() {
  ...
  scene.fog = new THREE.FogExp2(0x050404, 0.008);
  ...
  // Lighting
  const ambient = new THREE.AmbientLight(0x2a2218, 0.5);
  scene.add(ambient);

  const point = new THREE.PointLight(0xd4a574, 2, 200);
  point.position.set(0, 0, 0);
  scene.add(point);

  const backLight = new THREE.PointLight(0x4a3f32, 1, 300);
